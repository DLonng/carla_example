...
def main():
    ...
    while True:
        # The loop starts, waiting for a simulation tick with a timeout of 30.0 seconds. 
        # The returned timestamp contains the time information.
        timestamp = world.wait_for_tick(seconds=30.0).timestamp
        # representing the time passed since the last tick.
